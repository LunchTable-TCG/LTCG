...
export const triggerConditionValidator = v.union(
  ...
  v.literal("on_main_start"),
  v.literal("on_combat_start"),
  v.literal("on_combat_end"),
  v.literal("on_breakdown_check"),
...
export const jsonConditionValidator = v.object({
  ...
  cardType: v.optional(
    v.union(v.literal("stereotype"), v.literal("spell"), v.literal("trap"), v.literal("class"))
  ),
