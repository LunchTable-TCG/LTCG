 ...
 */
async function setSpellTrapHandler(
  ctx: MutationCtx,
  args: { lobbyId: Id<"gameLobbies">; cardId: Id<"cardDefinitions"> },
...
export const setSpellTrap = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    return setSpellTrapHandler(ctx, args, user);
  },
});
 ...
 */
async function activateSpellHandler(
  ctx: MutationCtx,
  args: {
...
export const activateSpell = mutation({
  ...
  handler: async (ctx, args) => {
    const user = await requireAuthMutation(ctx);
    return activateSpellHandler(ctx, args, user);
  },
});
 ...
 */
async function activateTrapHandler(
  ctx: MutationCtx,
  args: {
    lobbyId: Id<"gameLobbies">;
    cardId: Id<"cardDefinitions">;
...
export const activateTrap = mutation({
  ...
  handler: async (ctx, args) => {
    const user = await requireAuthMutation(ctx);
    return activateTrapHandler(ctx, args, user);
  },
});
