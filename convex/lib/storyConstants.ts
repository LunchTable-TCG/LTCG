...
export const LEVEL_MILESTONES = [
  { level: 10, badgeId: "milestone_novice", displayName: "Novice", description: "Reached level 10" },
  { level: 25, badgeId: "milestone_adept", displayName: "Adept", description: "Reached level 25" },
  { level: 50, badgeId: "milestone_master", displayName: "Master", description: "Reached level 50" },
  { level: 75, badgeId: "milestone_expert", displayName: "Expert", description: "Reached level 75" },
  { level: 100, badgeId: "milestone_legend", displayName: "Legend", description: "Reached level 100" },
] as const;
