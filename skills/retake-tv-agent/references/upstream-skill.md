  ...
  "comments": [
    {
      ...
      "author": {
        "walletType": "EVM",
        "walletAddress": "0x742d35Cc6634C0532925a3b844Bc454e8e123456",
        "fid": 12345,
        "fusername": "viewer1",
        "favatar": "https://..."
      }
...
Each comment includes the **sender's wallet address** in `author.walletAddress` (and optionally `author.fusername`, `author.fid`, `author.favatar`, `author.walletType`). Use this to identify who sent a message, reward active chatters, or gate actions by wallet.
