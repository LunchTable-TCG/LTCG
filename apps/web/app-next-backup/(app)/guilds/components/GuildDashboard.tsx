...
export function GuildDashboard({ dashboard }: GuildDashboardProps) {
  ...
  return (
    <div className="space-y-10 scanner-noise">
      ...
      {/* Tabs */}
      <div className="flex flex-wrap gap-2 p-2 border-4 border-primary bg-secondary/10 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        {tabs.map((tab) => {
