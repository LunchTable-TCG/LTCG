              ...
              <div key={member.userId} className="relative group/member">
                ...
                {actionMenu === member.userId && isOwner && (
                  <>
                    ...
                    {/* Menu */}
                    <div className="absolute right-4 top-16 z-50 w-56 border-4 border-primary bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
...
function MemberCard({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-4 p-5 border-4 transition-all relative group/card overflow-hidden bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5",
    ...
    >
      ...
      {showActions && !isOwner && (
        <Button
          ...
          className={cn(
            "rounded-none border-2 border-primary w-10 h-10 transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)]",
            isActionOpen
