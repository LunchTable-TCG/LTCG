...
export function CreateGameModal({ isOpen, onClose, onSubmit }: CreateGameModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md mx-4 tcg-chat-leather rounded-2xl border border-[#3d2b1f] shadow-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-200">
