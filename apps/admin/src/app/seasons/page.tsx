...
function CreateSeasonDialog({ open, onOpenChange }: CreateSeasonDialogProps) {
  ...
  const createSeason = useConvexMutation(typedApi.admin.seasons.createSeason);
...
export default function SeasonsPage() {
  ...
  const seasonsResult = useConvexQuery(typedApi.admin.seasons.listSeasons, {
    status: statusFilter !== "all" ? (statusFilter as SeasonStatus) : undefined,
  });

  const seasonStats = useConvexQuery(typedApi.admin.seasons.getSeasonStats, {});
