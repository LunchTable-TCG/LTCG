/**
 * Base Tailwind CSS configuration for LTCG monorepo
 *
 * Provides consistent theme tokens, colors, and animations across all applications.
 * Apps should extend this configuration with their specific content paths.
 */
...
/**
 * Create a Tailwind preset with custom content paths
 *
 * @example
 * ```ts
 ...
 *   content: ["./src/star-star/star.tsx"]
 * });
 * ```
 */
