...
describe("StateAggregator - Data Aggregation", () => {
  ...
  describe("getAgentStatus", () => {
    ...
    it("should throw error if polling service unavailable", async () => {
      ...
      await expect(freshAggregator.getAgentStatus("test-agent")).rejects.toThrow(
        "Polling service not available"
      );
    });
  });
  ...
  describe("getMatchmakingStatus", () => {
    it("should return matchmaking status from polling service", async () => {
      ...
      (mockPollingService.getMatchmakingStatus as ReturnType<typeof mock>).mockReturnValue(
        customStatus
      );
  ...
  describe("getGameState", () => {
    ...
    it("should throw error if API client unavailable", async () => {
      ...
      await expect(aggregator.getGameState("test-agent", "game-789")).rejects.toThrow(
...
describe("StateAggregator - Error Handling", () => {
  ...
  it("should propagate API errors from getGameState", async () => {
    await expect(aggregator.getGameState("test-agent", "game-error")).rejects.toThrow("API Error");
  });
  ...
  it("should handle missing polling service for getGameState", async () => {
    ...
    await expect(freshAggregator.getGameState("test-agent", "game-123")).rejects.toThrow(
